...
- (void)applicationDidEnterBackground:(UIApplication *)application {
    ...
    UIBackgroundTaskIdentifier ids = [application beginBackgroundTaskWithName:@"myTask" expirationHandler:^{
        [application endBackgroundTask:ids];
    }];
}
